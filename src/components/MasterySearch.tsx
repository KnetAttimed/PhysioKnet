              ...
              <div className="flex-1 overflow-y-auto space-y-3 custom-scroll">
                {query.trim() === '' ? (
                  <div className="flex flex-col items-center justify-center h-full text-center p-8">
                    ...
                    <h4 className="text-[var(--secondary-text)] font-sans mb-2">Neural Search Ready</h4>
                    <p className="text-[var(--secondary-text)] opacity-70 text-sm max-w-xs mx-auto">Access any biological mechanism instantly. Try "Cardiac Cycle" or "Sodium Channel".</p>
                  </div>
                ) : filtered.length > 0 ? (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <div className="text-[var(--app-text)] font-bold text-base md:text-lg group-hover:text-gemini-blue transition-colors font-sans flex items-center gap-2">
                          {item.topic} {item.type === 'elite' && <Zap className="w-4 h-4 text-amber-500 fill-amber-500" />}
                        </div>
